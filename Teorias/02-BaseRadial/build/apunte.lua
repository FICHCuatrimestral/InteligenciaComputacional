--[[
  ...
  2. Recuadros: una cita que empieza con **OJO**, **IDEA DE FONDO**,
     **PARA LA DEFENSA**, **EN CRIOLLO** o **EN NÚMEROS** se convierte en un
     tcolorbox del color correspondiente.
]]
...
local COLORES_RECUADRO = {
  ...
  ["EN CRIOLLO"]       = "recuadrocriollo",
  ["EN NÚMEROS"]       = "recuadronumeros",
}
